...
class TestGdxMerge(unittest.TestCase):
    ...
    def test_small_example_and_full_example(self) -> None:
        ...
        symbols: dict[str, list[list[str | float]]] = {
            ...
            "z": [["full_example", 153.675, 0.0, float("-inf"), float("inf"), 1.0]],
            "cost": [["full_example", 0.0, 1.0, 0.0, 0.0, 1.0]],
            "supply": [
    ...
    def test_small_example_and_small_example_changed_data_and_full_example(
        self,
    ) -> None:
        output = self.run_gdxmerge(
            [
