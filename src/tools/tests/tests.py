...
def main() -> int:
    ...
    parser.add_argument('-s', '--static-output', help='generate static output files', action='store_true')
    parser.add_argument('-t', '--test-output', help='generate test output files', action='store_true')
    parser.add_argument('-c', '--use-checksums', help='use checksums as output files', action='store_true')
    parser.add_argument('-r', '--run-tests', help='run all tests (combine with -d option to run tests in a directory with GDX files)', action='store_true')
    ...
    parser.add_argument('-m', '--minimal-tests', help='only run the minimal tests (also affects generated gdxdump options)', action='store_true')
    parser.add_argument('-md', '--max-diff', help='print test diff in full length', action='store_true')
