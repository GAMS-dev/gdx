         ...
         char buf[], size_t bufSiz, int *decpt, int *sign, char **rve)
{
 /*     Arguments ndigits, decpt, sign are similar to those
        ...
        mode:
                ...
                The returned value will not be zero-filled.  It is not
                expected or required to include space for zero-filling.
        */
...
dtoaInfoLoc (void)
{
  ...
  printf ("        FLT_ROUNDS :     defined\n");
#else
  printf ("        FLT_ROUNDS : NOT defined\n");
#endif
  ...
  printf ("1==Rounding is the usual case: round-nearest\n");
  printf ("\n");
